...
def main():
    ...
    with st.form("game_form"):
        ...
        price = st.text_input("Введите цену игры*", value="0.00")  # Маска заполнения
        ...
        col1, col2 = st.columns([7, 1])  # Ширина колонок настроена так, чтобы разместить кнопки справа
        with col2:
            submit_button = st.form_submit_button("Добавить", help="Добавить игру в систему")
            st.write("")  # Убираем лишнее пространство между кнопками
