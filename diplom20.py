...
def main():
    ...
    with st.form("login_form"):
        ...
        # Кнопки "Запомнить меня" и "Забыли пароль?" на одной строке
        col1, col2 = st.columns([1, 2])  # Настройка пропорций колонок
        with col1:
        ...
        col1, col2, col3 = st.columns([2, 4, 2])  # Центрирование кнопки через колонки
        with col2:
