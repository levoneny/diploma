...
def main():
    ...
    # Шапка с навигацией, логотипом и Профиль | Выйти справа
    st.markdown("""
    <style>
        .header {
            display: flex;
    ...
    with st.form("game_form"):
        ...
        price = st.text_input("Цена игры*", value="0.00")  # Добавлена маска заполнения 0.00
        ...
        # Кнопки внизу формы, на одном уровне
        col1, col2 = st.columns([8, 2])  # Настройка ширины колонок
        with col2:
